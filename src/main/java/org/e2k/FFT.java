...
public class FFT extends Core {
	...
	public DoubleFFT_1D fft96=new DoubleFFT_1D(FFT_96_SIZE);
	...
	public DoubleFFT_1D fft240=new DoubleFFT_1D(FFT_240_SIZE);
	public DoubleFFT_1D fft264=new DoubleFFT_1D(FFT_264_SIZE);
